                ...
                <div class="border border-secondary border-opacity-50 p-3 bg-light">
                    <div class="row">
                        <div class="col-xl-3">
                            ...
                            <div>
                                <img class="border border-secondary border-opacity-50 rounded img-fluid variant-image" :src="variant.image ? '/storage/products/media/' + variant.image : '/imgs/no_image.png'"  data-bs-toggle="modal" :data-bs-target="'#image'+index">
                            </div>
